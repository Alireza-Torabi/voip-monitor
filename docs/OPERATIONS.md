...
**Status:** The local backend has authenticated PBX onboarding with encrypted AMI password storage. There is no monitoring service or tested backup/restore procedure yet.
