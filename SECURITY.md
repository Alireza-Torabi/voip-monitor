...
Future production releases must use authentication, HTTPS, least-privilege PBX access, encrypted local secret storage, and tested backup and restore. These controls are planned, not implemented.
